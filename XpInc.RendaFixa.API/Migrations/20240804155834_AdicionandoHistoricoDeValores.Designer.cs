...
namespace XpInc.RendaFixa.API.Migrations
{
    ...
    [Migration("20240804155834_AdicionandoHistoricoDeValores")]
    partial class AdicionandoHistoricoDeValores
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XpInc.Core.Messages.Event", b =>
                {
                    ...
                    b.Property<Guid?>("RendaFixaHistoricoId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RendaFixaHistoricoId");
            ...
            modelBuilder.Entity("XpInc.RendaFixa.API.Models.Entities.RendaFixaHistorico", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("XpInc.RendaFixa.API.Models.Entities.RendaFixaProduto", b =>
                {
                    ...
                    b.Property<int?>("QuantidadeCotasDisponivel")
                        .HasColumnType("int");

                    b.Property<int?>("QuantidadeCotasInicial")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("XpInc.Core.Messages.Event", b =>
                {
                    b.HasOne("XpInc.RendaFixa.API.Models.Entities.RendaFixaHistorico", null)
                        .WithMany("Notificacoes")
                        .HasForeignKey("RendaFixaHistoricoId");
